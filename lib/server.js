...
(function() {
  var Api, Generator, Validate, coffee, createFnFiles, createServer, ensureDirExists, fs;
...
server.listen PORT, ->
  ...
  exports.Server = Generator({
    ...
    once: function() {
      ...
      createFnFiles.call(this);
      return createServer.call(this);
    },
    call: function(dir) {
