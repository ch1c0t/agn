...
(function() {
  var Client, Server, YAML, build, chokidar, cwd, ensureDirExists, fs, getSources, nodemon, path, printHelp, watch;
  ...
  watch = function() {
    ...
    return nodemon({
      ...
      return console.log('nodemon started');
    }).on('quit', function() {
      return console.log('nodemon quit');
    }).on('restart', function(files) {
      return console.log(`The server restarted due to: ${files}`);
    });
  };
